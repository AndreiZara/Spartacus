    namespace Spartacus.BusinessLogic.Migrations
{
    ...
    public partial class FirstLastName : DbMigration
    {
        ...
        {
            AddColumn("dbo.UDbTables", "Firstname", c => c.String(nullable: false, maxLength: 20));
            AddColumn("dbo.UDbTables", "Lastname", c => c.String(nullable: false, maxLength: 20));
            AddColumn("dbo.UDbTables", "LastIp", c => c.String(maxLength: 16));
